...
`vfwoo-webkul-pos-bridge` (v0.1.0.6 dev, rama `dev-vfwoo-webkul-pos-bridge`, Webkul POS 7.1.1)
...
Elegir entre QA detallada, diagnóstico en Settings o botón/versión de catálogo para recarga completa.
