...
`vfwoo-webkul-pos-bridge` (v0.1.1.1 dev, última release estable 0.1.1, rama `dev-vfwoo-webkul-pos-bridge`, Webkul POS 7.1.1)
...
- Versión 0.1.1 **publicada** (`pos-v0.1.1`, ver `proceso-release.md` y D-019). El desarrollo está en `0.1.1.1`.
...
- **Confirmar los estilos** de «Marcas» y de la ventana F3 en tema claro y oscuro (D-020).
